...
def output( inputURL ):
	...
	return ([var0,name0],[var1,name1],[var2,name2])

#Change around to take user input instead of constant test link	
ans = output('https://image.shutterstock.com/image-photo/santorini-greece-picturesq-view-traditional-260nw-1040803156.jpg')
